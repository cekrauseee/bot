          ...
          {Array.from({ length }, (_, i) => {
            ...
            return (
              <div
                ...
                data-filled={char !== ""}
                className={cn(
                  "relative grid h-11 w-9 place-items-center overflow-hidden rounded-lg border text-lg font-semibold tabular-nums transition-colors duration-200",
                  showSuccess
                    ? "border-(--color-success)/60 text-foreground"
                    : status === "error"
              ...
              >
                ...
                {isActive && !showSuccess ? (
                  <motion.span
                    ...
                    className={cn(
                      "pointer-events-none absolute top-1/2 h-5 w-px -translate-y-1/2 bg-foreground",
                      char ? "right-2.5" : "left-1/2 -translate-x-1/2",
                    )}
                  />
                ) : null}
        ...
        <AnimatePresence>
          {showSuccess ? (
            <motion.span
              ...
              className="pointer-events-none absolute -right-6 top-1/2 -translate-y-1/2 text-(--color-success)"
              aria-hidden
            >
              <svg
                width="20"
