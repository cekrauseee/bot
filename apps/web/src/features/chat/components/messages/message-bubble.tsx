...
function bubbleContentClass(
  ...
  return cn(
    "relative z-0 min-w-9 max-w-[82%] rounded-2xl px-4 py-3 text-sm leading-5 text-foreground",
    ...
    variant === "solid" && "text-message-user-foreground selection:bg-background selection:text-foreground [&_*::selection]:bg-background [&_*::selection]:text-foreground",
