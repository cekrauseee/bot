...
export const users = pgTable(
  'users',
  {
    ...
    defaultReasoningEffort: varchar('default_reasoning_effort', { length: 20 }).default('medium').notNull(),
    defaultSpeed: varchar('default_speed', { length: 20 }).default('standard').notNull(),
...
export const conversations = pgTable('conversations', {
  ...
  speed: varchar('speed', { length: 20 }).default('standard').notNull(),
